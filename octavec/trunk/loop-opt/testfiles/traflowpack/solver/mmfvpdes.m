function varargout = mmfvpdes(action, f_settings, N, Tstart, Tend, varargin)
...
case 'plot'
    ...
    if nargin > 12 & strcmp(varargin{8},'save')
        storeInFile = 1;
    end
    if nargin > 13 & strcmp(varargin{9},'errorcheck')
        errorCheck = 1;
    end
case 'exact'
    storeAll = 0;
