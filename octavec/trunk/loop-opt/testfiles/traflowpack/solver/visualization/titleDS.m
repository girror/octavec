function titleDS(ah)
%TITLEDS    show current datasource in title
%   TITLEDS(axeshandle) sets the current datasource
%   (i.e. Simulation data or .mat-filename) as axestitle
...
if nargin > 0, axes(ah); end

% Please, no TeX interpretation here.
title(['Datasource: ', MM_datasource],'Interpreter','none');
