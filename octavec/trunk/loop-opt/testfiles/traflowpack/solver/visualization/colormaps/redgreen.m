function rg = redgreen(m)
%REDGREEN   Spectrum from intense red to soft green
%   REDGREEN(M) returns an M-by-3 matrix containing a "redgreen" colormap.
%   REDGREEN, by itself, is the same length as the current colormap.
%
