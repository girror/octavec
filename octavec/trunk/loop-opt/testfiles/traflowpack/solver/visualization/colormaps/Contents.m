% MMFVPDES additional colormaps
%     fact             - non-linear spectrum for factors around 1.
%     factgv           - gray-valued non-linear spectrum for factors around 1.
%     redblue          - linear spectrum from intense red to soft blue.
%     redgreen         - linear spectrum from intense red to soft green.
