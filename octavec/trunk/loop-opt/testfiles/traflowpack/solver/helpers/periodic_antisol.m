function u = periodic_antisol(t, x, u)
% PERIODIC_ANTISOL negated periodical boundary conditions
%   u = PERIODIC_ANTISOL(t, x, u) where x is an 1 x (MM_NX+2) matrix
...
%   negated periodical boundary values added to it:
%   u([1, 2, MM_NX, MM_NX+1]) = -u([MM_NX-2, MM_NX-1, 3, 4]);
%
%   See also: PERIODIC_SOL, NEUMANN_SOL
