function dudxi = ddxi(u, dxi)
% DDXI centered first-order spatial derivative on uniform mesh
%   dudxi = DDXI(u, dxi) where dxi is the cellsize of the uniform mesh (float)
%   and u is an m x n matrix (possibly m==1) of solution values
%   at the meshpoints,
%   returns an m x (n-1) matrix of first-order derivatives du/dxi
