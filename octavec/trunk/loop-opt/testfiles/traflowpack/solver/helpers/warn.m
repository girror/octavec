...
%   WARN(msg)  displays a warning message, with the string
%   'WARNING: ' in front of it, and without linenumbers or debug-info.
%
%   Mainly meant to bypass genuine matlab-warnings that tend to halt the program.
