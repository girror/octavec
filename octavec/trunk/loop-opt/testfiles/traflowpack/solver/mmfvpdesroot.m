function s = mmfvpdesroot()
%MMFVPDESROOT root of the MMFVPDES program
%   MMFVPDESROOT returns the full path to the root of the moving mesh solver.

%   NOTE! This file mmfvpdesroot.m should always be placed in the MMFVPDES-program rootdir.
