function s = traflowroot()
%TRAFLOWROOT root of the TraFlow program (not the package)
%   TRAFLOWROOT returns the full path to the root of the TraFlow program.

%   NOTE! This file traflowroot.m should always be placed in the TraFlow-program rootdir.
