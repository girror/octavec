% TraFlow visualization routines
% 
%   Data plots.
%     trajectories     - x-t top view of some trajectories, with flow-coloring underneath.
%     roaddensityplot  - a real-world plot of a highway with lanes and a 3d-density ribbon
%     densityAnimation - creates a movie of a timeseries of roaddensityplots and moving
%                        cars on the road.
