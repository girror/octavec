function s = traflowpackroot()
%TRAFLOWPACKROOT root of the entire TraFlow package
%   TRAFLOWPACKROOT returns the full path to the root of the TraFlow package.

%   NOTE! This file traflowpackroot.m should always be placed in the TraFlow-package rootdir.
