...
% KERNER_F   f definition for Kerners model
...
f(getIdx(1),:) = w(getIdx(1),:).*w(getIdx(2),:);
f(getIdx(2),:) = 0.5*w(getIdx(2),:).^2 + sameAllPoints(sameAllLanes(c0).^2).*log(w(getIdx(1),:)+1e-14);
